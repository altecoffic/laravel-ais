...
<body style="width:400px;margin:auto;">
    ...
    <div class="container shadow-lg"><br>
        ...
        <form class='login-form' action="{{route('students.store')}}" method="POST">
            @csrf

            <div class="flex-row">

                <input id="username" class='lf--input ' name="studname" placeholder='Name' type='text' required>
            </div>
            <div class="flex-row">

                <input id="password" class='lf--input' name="course" placeholder='Course' type='text' required>
            </div>
            <div class="flex-row">

                <input id="year" class='lf--input' name="year" placeholder='Year' type='text' required>
            </div>
